 ...
 * The elements are named 0 through <em>n</em>–1. Initially, there are <em>n</em> sets, with each
 * element in its own set. The <em>cannonical elemement</em> of a set (also known as the
 * <em>root</em>, <em>identifier</em>,
 * <em>leader</em>, or <em>set representative</em>)
 * is one distinguished element in the set. Here is a summary of he operations:
 * <ul>
